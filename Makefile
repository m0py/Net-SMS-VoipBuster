...
MAKE = make
FULLEXT = Net/SMS/VoipBuster
BASEEXT = VoipBuster
PARENT_NAME = Net::SMS
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Net/SMS/VoipBuster.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/SMS/VoipBuster.pm
...
TO_INST_PM = lib/Net/SMS/VoipBuster.pm

PM_TO_BLIB = lib/Net/SMS/VoipBuster.pm \
...
manifypods : pure_all  \
	lib/Net/SMS/VoipBuster.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/SMS/VoipBuster.pm $(INST_MAN3DIR)/Net::SMS::VoipBuster.$(MAN3EXT) 
